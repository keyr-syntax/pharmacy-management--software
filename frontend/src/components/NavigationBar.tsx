  ...
  return (
    <>
      <Menubar.Root className="flex flex-row items-center md:justify-start bg-[#151533]  p-3 border border-[rgb(255,255,255,0.1)]  rounded-none  z-50 fixed top-0 left-0 right-0 gap-5">
        ...
        {menuOpen && (
          <div className="flex flex-col lg:hidden items-center justify-center bg-[#151533]  p-3 border border-[rgb(255,255,255,0.1)]  rounded-none  z-50 fixed top-16 left-0 right-0 gap-5">
            <Menubar.Menu>
              <Menubar.Trigger className="flex lg:hidden select-none items-center justify-between gap-0.5 rounded px-3 py-2 text-[20px]  leading-none text-violet11 outline-none data-[highlighted]:bg-violet4 data-[state=open]:bg-violet4">
                Employees
              </Menubar.Trigger>
              <Menubar.Portal>
                <Menubar.Content
